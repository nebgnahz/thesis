...
simple measurement using Amazon EC2. iPerf~\cite{iperf3} was used to measure the
...
source when backpressure happens~\cite{sanjeev2015twitter}.

\para{WAN-aware:} There is a growing interest in building systems that optimizes
data transfers for the wide area, such as GDA~\cite{pu2015low} and
Clarinet~\cite{viswanathan2016clarinet}.  Most of these works focus on one-time
queries or operations (such as data
