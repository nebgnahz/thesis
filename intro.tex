...
\para{Constrained Resources.} Both network resources and compute resources in
...
\para{Large Design Space.} Many swarm applications have tunable parameters with
