...
\para{Offloading Augments Mobile Devices.} To improve application performance
...
\para{Redundancy Tackles Latency Variability.} The idea of initiating redundant
