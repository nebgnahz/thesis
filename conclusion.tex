...
design, implementation, and evaluation of \awstream{}. We demonstrate that with
...
profiling efficiency. We demonstrate that Bayesian Optimization significantly
reduces the number of samples needed from the large parameter space and profile
transfer eliminates the need for profiling for each new device.
