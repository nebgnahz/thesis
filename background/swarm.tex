...
engineering insights with dense temporal and spatial measurements. Without an
exhaustive list from the rich literature~\cite{akyildiz2002wireless,
  zhao2009wireless}, we list a few notable representative deployments as
follows,
...
\noindent Compared with WSNs, the swarm is one step further, as we illustrate below with
their differences,

\para{WSN is application-specific; the swarm can re-purpose itself}.
...
\para{WSN runs on a dedicated set of resources; the swarm can dynamically
